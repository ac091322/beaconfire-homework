...
mongoose.connect(mongoUri)
    ...
    .catch((error) => { console.error("MongoDB conection error:", error) });
...
// listen for the "reconnected" event indicating that Mongoose has successfully reconnected to MongoDB
db.on("reconnected", () => {
